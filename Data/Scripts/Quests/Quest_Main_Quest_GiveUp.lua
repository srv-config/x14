...
function EP2_GiveUp_Level_check(iObjIndex, Ep, QS)
	...
	if CharClass == CLASS_KNIGHT or CharClass == CLASS_WIZARD or CharClass == CLASS_ELF or CharClass == CLASS_SUMMONER or CharClass == CLASS_MAGUMSA or CharClass == CLASS_DARKLORD or CharClass == CLASS_MONK or CharClass == CLASS_GROWLANCER then
		if CharMaster == 0 then
			if UserLv >= 50 and UserLv <= 179 then
			...
			elseif UserLv >= 180 and UserLv <= 269 then
...
function EP5_GiveUp_Level_check(iObjIndex, Ep, QS)
	...
	local UserLv = LuaQuestClass:GetUserLv(iObjIndex)
	if CharMaster == 0 then	
		if UserLv >= 180 and UserLv <= 269 then -- 환영사원 1구간
			if QS >= 1 and QS <= 8 then
		...
		elseif UserLv >= 270 and UserLv <= 400 then -- 환영사원 2구간
	...
	elseif CharMaster == 1 then	
		if UserLv >= 400 and UserLv <= 500 then -- 환영사원 3구간
			if QS < 30 then
		...
		elseif UserLv >= 501 and UserLv <= 650 then -- 환영사원 4구간
		...
		elseif UserLv >= 651 and UserLv <= 770 then -- 환영사원 5구간
			if QS < 43 then
