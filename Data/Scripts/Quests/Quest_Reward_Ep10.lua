...
LuaQuestClass:SetQuestProgress(ASK1, Ep10, 2)
	...
	LuaQuestClass:SetQuestDropItem(Ep10, 1, ASK1, 557, 100, ItemType, ItemIndex, ItemLevel, ItemCnt)		-- 사피퀸
	
	ItemType = 13 ItemIndex = 149 ItemLevel = 0 ItemSkill = 0 ItemCnt = 10 Opt = 0 ExOpt = 0
	LuaQuestClass:SetQuestGetItem(ASK1, Ep10, 1, ItemType, ItemIndex, ItemLevel, ItemSkill, ItemCnt, Opt, ExOpt)	-- 파란색 잉크 10개
...
LuaQuestClass:SetQuestProgress(ASK1, Ep10, 5)	
	...
	LuaQuestClass:SetQuestDropItem(Ep10, 4, ASK1, 562, 100, ItemType, ItemIndex, ItemLevel, ItemCnt)		-- 다크매머드
	
	ItemType = 13 ItemIndex = 151 ItemLevel = 0 ItemSkill = 0 ItemCnt = 1 Opt = 0 ExOpt = 0
	LuaQuestClass:SetQuestGetItem(ASK1, Ep10, 4, ItemType, ItemIndex, ItemLevel, ItemSkill, ItemCnt, Opt, ExOpt)	-- 정신의 양피지
	
	ItemType = 13 ItemIndex = 157 ItemLevel = 0 dur = 0 ItemSkill = 0 ItemCnt = 1 
	LuaQuestClass:SetQuestRewardItem(Ep10, 4, ItemType, ItemIndex, ItemLevel, dur, ItemSkill, ItemCnt)		-- 봉인된 파란 망각의 두루마리
end
--================================================================================================================	
