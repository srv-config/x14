...
-- 창고 확장
	...
	LuaQuestClass:SetQuestDropItem(Ep7, 4, ASK1, 40, 100, ItemType, ItemIndex, ItemLevel, ItemCnt)--데쓰나이트
...
-- 1차 인벤토리
	...
	LuaQuestClass:SetQuestDropItem(Ep7, 9, ASK1, 52, 100, ItemType, ItemIndex, ItemLevel, ItemCnt)--실버발키리
...
-- 2차 인벤토리
	...
	LuaQuestClass:SetQuestDropItem(Ep7, 14, ASK1, 69, 100, ItemType, ItemIndex, ItemLevel, ItemCnt)--알카모스
