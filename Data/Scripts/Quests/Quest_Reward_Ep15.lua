...
-- 던전 정복(5)(131~140레벨)
	...
	LuaQuestClass:SetQuestMonsterKill(ASK1, Ep15, 30, 10, 80)--다크나이트
	...
	LuaQuestClass:SetQuestMonsterKill(ASK1, Ep15, 32, 10, 80)--다크나이트
...
-- 척후 부대 임무(1)(161~165레벨)
	...
	LuaQuestClass:SetQuestMonsterKill(ASK1, Ep15, 43, 20, 50)--설인대장
	...
	LuaQuestClass:SetQuestMonsterKill(ASK1, Ep15, 45, 20, 50)--설인대장
...
-- 이계 탐사(5)(202~205레벨)
	...
	LuaQuestClass:SetQuestMonsterKill(ASK1, Ep15, 90, 35, 100)--데스고르곤
	...
	LuaQuestClass:SetQuestMonsterKill(ASK1, Ep15, 92, 35, 100)--데스고르곤
