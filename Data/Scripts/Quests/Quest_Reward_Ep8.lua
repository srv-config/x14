...
[ Author ]	
[ Version ]	0.0.0.3
[ Text ]	Season10 P.3 업데이트에 따른 아케론 퀘스트 수정
[ Desc ]									
--]]
--================================================================================================================
...
LuaQuestClass:SetQuestProgress(ASK1, Ep8, 4)--대화 진행상 완료창이 필요한 경우 사용
	...
	LuaQuestClass:SetQuestRewardItem(Ep8, 5, ItemType, ItemIndex, ItemLevel, dur, ItemSkill, ItemCnt)		-- 엘리멘탈 룬
...
LuaQuestClass:SetQuestProgress(ASK1, Ep8, 15)--대화 진행상 완료창이 필요한 경우 사용
	...
	LuaQuestClass:SetQuestGetItem(ASK1, Ep8, 16, ItemType, ItemIndex, ItemLevel, ItemSkill, ItemCnt, Opt, ExOpt)	-- 미스릴 체크
	
	LuaQuestClass:SetQuestRewardExp(Ep8, 16, 100000)
	ItemType = 12 ItemIndex = 288 ItemLevel = 0 dur = 1 ItemSkill = 0 ItemCnt = 1 
	LuaQuestClass:SetQuestRewardItem(Ep8, 16, ItemType, ItemIndex, ItemLevel, dur, ItemSkill, ItemCnt)		-- 엘리멘탈 룬
...
LuaQuestClass:SetQuestProgress(ASK1, Ep8, 18)--대화 진행상 완료창이 필요한 경우 사용
	...
	LuaQuestClass:SetQuestGetItem(ASK1, Ep8, 19, ItemType, ItemIndex, ItemLevel, ItemSkill, ItemCnt, Opt, ExOpt)	-- 속성가루
	
	LuaQuestClass:SetQuestRewardExp(Ep8, 19, 100000)
	ItemType = 12 ItemIndex = 288 ItemLevel = 0 dur = 1 ItemSkill = 0 ItemCnt = 1 
	LuaQuestClass:SetQuestRewardItem(Ep8, 19, ItemType, ItemIndex, ItemLevel, dur, ItemSkill, ItemCnt)		-- 엘리멘탈 룬
...
LuaQuestClass:SetQuestProgress(ASK1, Ep8, 28)--대화 진행상 완료창이 필요한 경우 사용
	...
	LuaQuestClass:SetQuestRewardItem(Ep8, 29, ItemType, ItemIndex, ItemLevel, dur, ItemSkill, ItemCnt)		-- 미스릴
...
LuaQuestClass:SetQuestProgress(ASK1, Ep8, 31)--대화 진행상 완료창이 필요한 경우 사용
	...
	ItemType = 12 ItemIndex = 145 ItemLevel = 0 dur = 1 ItemSkill = 0 ItemCnt = 1 
	LuaQuestClass:SetQuestRewardItem(Ep8, 32, ItemType, ItemIndex, ItemLevel, dur, ItemSkill, ItemCnt)		-- 미스릴
...
LuaQuestClass:SetQuestProgress(ASK1, Ep8, 34)--대화 진행상 완료창이 필요한 경우 사용
	...
	LuaQuestClass:SetQuestRewardItem(Ep8, 35, ItemType, ItemIndex, ItemLevel, dur, ItemSkill, ItemCnt)		-- 속성가루
...
LuaQuestClass:SetQuestProgress(ASK1, Ep8, 40)--대화 진행상 완료창이 필요한 경우 사용
	...
	ItemType = 14 ItemIndex = 290 ItemLevel = 0 dur = 1 ItemSkill = 0 ItemCnt = 1 
	LuaQuestClass:SetQuestRewardItem(Ep8, 41, ItemType, ItemIndex, ItemLevel, dur, ItemSkill, ItemCnt)		-- 속성가루
...
LuaQuestClass:SetQuestProgress(ASK1, Ep8, 43)--대화 진행상 완료창이 필요한 경우 사용
	...
	ItemType = 12 ItemIndex = 288 ItemLevel = 0 dur = 1 ItemSkill = 0 ItemCnt = 1 
	LuaQuestClass:SetQuestRewardItem(Ep8, 44, ItemType, ItemIndex, ItemLevel, dur, ItemSkill, ItemCnt)		-- 엘리멘탈 룬
