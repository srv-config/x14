...
function Ep2_NPCTalkList(iObjIndex)
	...
	if CharClass == CLASS_KNIGHT or CharClass == CLASS_WIZARD or CharClass == CLASS_ELF or CharClass == CLASS_SUMMONER or CharClass == CLASS_MAGUMSA or CharClass == CLASS_DARKLORD or CharClass == CLASS_MONK or CharClass == CLASS_GROWLANCER then
		if CharMaster == 0 then
			if UserLv >= 50 and UserLv <= 179 then -- 카오스캐슬 1구간
			...
			elseif UserLv >= 180 and UserLv <= 269 then -- Chaos Castle 2
				QS = LuaQuestClass:GetQuestSwitch(Ep2, iObjIndex)
			...
			elseif UserLv >= 270 and UserLv <= 349 then -- Chaos Castle 3
				QS = LuaQuestClass:GetQuestSwitch(Ep2, iObjIndex)
			...
			elseif UserLv >= 350 and UserLv <= 400 then -- Chaos Castle 4
				QS = LuaQuestClass:GetQuestSwitch(Ep2, iObjIndex)
		...
		elseif CharMaster == 1 then
			if UserLv >= 400 and UserLv <= 500 then -- Chaos Castle 5
				QS = LuaQuestClass:GetQuestSwitch(Ep2, iObjIndex)
			...
			elseif UserLv >= 501 and UserLv <= 650 then -- Chaos Castle 6
				QS = LuaQuestClass:GetQuestSwitch(Ep2, iObjIndex)
			...
			elseif UserLv >= 651 and UserLv <= 770 then -- Chaos Castle 7
				QS = LuaQuestClass:GetQuestSwitch(Ep2, iObjIndex)
...
function Ep3_NPCTalkList(iObjIndex)
	...
	if CharClass == CLASS_KNIGHT or CharClass == CLASS_WIZARD or CharClass == CLASS_ELF or CharClass == CLASS_SUMMONER or CharClass == CLASS_MAGUMSA or CharClass == CLASS_DARKLORD or CharClass == CLASS_MONK or CharClass == CLASS_GROWLANCER then
		if CharMaster == 0 then
			if UserLv >= 50 and UserLv <= 179 then -- Blood Castle 1
				QS = LuaQuestClass:GetQuestSwitch(Ep3, iObjIndex)
				if QS >= 0 and QS <= 17 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep3, QS)-- NPC한테 보내줄 퀘스트
			...
			elseif UserLv >= 180 and UserLv <= 269 then -- Blood Castle 2
				QS = LuaQuestClass:GetQuestSwitch(Ep3, iObjIndex)
				if QS >= 18 and QS <= 35 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep3, QS)-- NPC한테 보내줄 퀘스트
			...
			elseif UserLv >= 270 and UserLv <= 349 then -- Blood Castle 3
				QS = LuaQuestClass:GetQuestSwitch(Ep3, iObjIndex)
				if QS >= 36 and QS <= 45 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep3, QS)-- NPC한테 보내줄 퀘스트
			...
			elseif UserLv >= 350 and UserLv <= 400 then -- Blood Castle 4
				QS = LuaQuestClass:GetQuestSwitch(Ep3, iObjIndex)
				if QS >= 46 and QS <= 54 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep3, QS)-- NPC한테 보내줄 퀘스트
		...
		elseif CharMaster == 1 then
			if UserLv >= 400 and UserLv <= 500 then -- Blood Castle 5
				QS = LuaQuestClass:GetQuestSwitch(Ep3, iObjIndex)
				if QS >= 55 and QS <= 63 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep3, QS)-- NPC한테 보내줄 퀘스트
			...
			elseif UserLv >= 501 and UserLv <= 650 then -- Blood Castle 6
				QS = LuaQuestClass:GetQuestSwitch(Ep3, iObjIndex)
				if QS >= 64 and QS <= 72 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep3, QS)-- NPC한테 보내줄 퀘스트
			...
			elseif UserLv >= 651 and UserLv <= 770 then -- Blood Castle 7
				QS = LuaQuestClass:GetQuestSwitch(Ep3, iObjIndex)
				if QS >= 73 and QS <= 81 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep3, QS)-- NPC한테 보내줄 퀘스트
...
function Ep4_NPCTalkList(iObjIndex)
	...
	if CharClass == CLASS_KNIGHT or CharClass == CLASS_WIZARD or CharClass == CLASS_ELF or CharClass == CLASS_SUMMONER or CharClass == CLASS_MAGUMSA or CharClass == CLASS_DARKLORD or CharClass == CLASS_MONK or CharClass == CLASS_GROWLANCER then
		if CharMaster == 0 then
			if UserLv >= 50 and UserLv <= 179 then -- Devil Square 1
				QS = LuaQuestClass:GetQuestSwitch(Ep4, iObjIndex)
				if QS >= 0 and QS <= 17 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep4, QS)-- NPC한테 보내줄 퀘스트
			...
			elseif UserLv >= 180 and UserLv <= 269 then -- Devil Square 2
				QS = LuaQuestClass:GetQuestSwitch(Ep4, iObjIndex)
				if QS >= 18 and QS <= 35 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep4, QS)-- NPC한테 보내줄 퀘스트
			...
			elseif UserLv >= 270 and UserLv <= 349 then -- Devil Square 3
				QS = LuaQuestClass:GetQuestSwitch(Ep4, iObjIndex)
				if QS >= 36 and QS <= 45 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep4, QS)-- NPC한테 보내줄 퀘스트
			...
			elseif UserLv >= 350 and UserLv <= 400 then -- Devil Square 4
				QS = LuaQuestClass:GetQuestSwitch(Ep4, iObjIndex)
				if QS >= 46 and QS <= 54 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep4, QS)-- NPC한테 보내줄 퀘스트
		...
		elseif CharMaster == 1 then
			if UserLv >= 400 and UserLv <= 500 then -- Devil Square 5
				QS = LuaQuestClass:GetQuestSwitch(Ep4, iObjIndex)
				if QS >= 55 and QS <= 63 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep4, QS)-- NPC한테 보내줄 퀘스트
			...
			elseif UserLv >= 501 and UserLv <= 650 then -- Devil Square 6
				QS = LuaQuestClass:GetQuestSwitch(Ep4, iObjIndex)
				if QS >= 64 and QS <= 72 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep4, QS)-- NPC한테 보내줄 퀘스트
			...
			elseif UserLv >= 651 and UserLv <= 770 then -- Devil Square 7
				QS = LuaQuestClass:GetQuestSwitch(Ep4, iObjIndex)
				if QS >= 73 and QS <= 81 then
					if ProgEp ~= 1 then
						LuaQuestClass:AddQuestExpNpcTalk(Ep4, QS)-- NPC한테 보내줄 퀘스트
...
function Ep5_NPCTalkList(iObjIndex)
	...
	if CharMaster == 0 then
		...
		if UserLv >= 180 and UserLv <= 269 then -- Illusion Temple 1
			QS = LuaQuestClass:GetQuestSwitch(Ep5, iObjIndex)
		...
		elseif UserLv >= 270 and UserLv <= 400 then -- Illusion Temple 2
			QS = LuaQuestClass:GetQuestSwitch(Ep5, iObjIndex)
	...
	elseif CharMaster == 1 then
		if UserLv >= 400 and UserLv <= 500 then -- Illusion Temple 3
			QS = LuaQuestClass:GetQuestSwitch(Ep5, iObjIndex)
		...
		elseif UserLv >= 501 and UserLv <= 650 then -- Illusion Temple 4
			QS = LuaQuestClass:GetQuestSwitch(Ep5, iObjIndex)
		...
		elseif UserLv >= 651 and UserLv <= 770 then -- Illusion Temple 5
			QS = LuaQuestClass:GetQuestSwitch(Ep5, iObjIndex)
