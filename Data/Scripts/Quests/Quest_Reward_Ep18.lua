...
-- 던전 상황 파악(6)(141~160레벨)
	...
	LuaQuestClass:SetQuestMonsterKill(ASK1, Ep18, 56, 8, 50)--포이즌 소뿔전사
...
-- 척후부대의 지속적인 도움 요청(1)(161~165레벨)
	...
	LuaQuestClass:SetQuestMonsterKill(ASK1, Ep18, 61, 20, 50)--설인대장
...
-- 이카루스 진입로 (220~229레벨)
	...
	LuaQuestClass:SetQuestMonsterKill(ASK1, Ep18, 88, 40, 60)--데스나이트
	...
	LuaQuestClass:SetQuestMonsterKill(ASK1, Ep18, 92, 40, 60)--데스나이트
